...
exports.updateUserToExpense = functions.firestore.document('users/{userId}/expenses/{expenseId}/users/{expenseUserId}').onUpdate((event) => __awaiter(this, void 0, void 0, function* () {
    const userId = event.params.userId;
    const expenseId = event.params.expenseId;
    const expenseUserId = event.params.expenseUserId;
    return replicateExpense(userId, expenseId, expenseUserId);
